...
let utility = [
	0x80dfff, 0xffff00, 0xff4040, 0x40ff40, 0x4080ff, 0xff8800, 0x00ff99,
	0xffcc00, 0xff0000, 0xff00ff, 0x00ffff, 0x00ff40, 0, 0xffffff, 0xffffff,
];
...
for (let i = 1; i < 256; i++) {
	...
	if (i < 5) ((x = 0xfffdf7), (y = 0xc9d9e8), (t = (i - 1) / 3));
		...
		((x = 0x172318), (y = 0x769b80), (t = (i - 49) / 23), (q = 225));
	else if (i < 89)
		((x = 0xffddc7), (y = 0x301c18), (t = (i - 73) / 15), (q = 220));
	else if (i < 101)
		((x = 0x111913), (y = 0x70462f), (t = (i - 89) / 11), (q = 225));
	else if (i < 105)
		((x = 0x1a2021), (y = 0x566267), (t = (i - 101) / 3), (q = 200));
	else if (i < 125)
		((x = 0x210006),
			(y = 0xff3652),
			(t = (i - 105) / 19),
		...
		((x = 0x1d2020), (y = 0x68705c), (t = (i - 157) / 19), (q = 230));
	else if (i < 189)
		((x = 0x20262d),
			(y = 0xb9cad3),
			(t = (i - 177) / 11),
...
for (let i = 0; i < 1024; i++)
	if ((i & 3) < 3) palette[i] = palette[i] ** 2 / 255;
