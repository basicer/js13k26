...
let utility = [
	0x80dfff, 0xffff00, 0xff4040, 0x40ff40, 0x4080ff,
	0xff8800, 0x00ff99, 0xffcc00, 0xff0000, 0xff00ff,
	0x00ffff, 0x00ff40, 0, 0xffffff, 0xffffff,
];

for (let i = 1; i < 256; i++) {
	let x, y, t, a = 255, m = 0, q = 180, e = 0;
