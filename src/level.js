...
// 10 portal facing -X, 16 portal facing +X, 17 portal facing +Z, 11 unicorn; place these after their section scenery.
...
const plan = [
	...
	9,12,-21.5,28.5,4,1,5,-19.7,31,8,-21.5,30.75,4,4.5,0,-23.5,30.75,0.2,4.5,0,-19.5,30.75,0.2,4.5,8,-29.5,20.25,24,16.5,0,-32.5,28.5,18,1,0,-18.5,28.5,2,1,1,-41.5,20.25,1,16.5,1,-17.5,20.25,1,16.5,0,-29.5,12,24,1,3,-35.5,22,3,-23.5,22,4,-29.5,16,2,-36.5,16,0,2,-22.5,16,0,2,-34.5,16,0,2,-24.5,16,0,2,-29.5,25,1,7,-35.5,27,7,-23.5,27,7,-29.5,15,10,-18.5,17,10,-18.5,24,17,-32.5,13
];
...
export function setupLevel(place) {
	...
	while (i < plan.length) {
		...
		const entity = spawn(door || track ? 19 : rail ? 14 : [7,253,16,7,7,15,14,1,5][type]);
...
export const collisionPosition = (entity, axis, world = false) => {
	let value = entity[E.POS + axis];
	while (entity[E.PARENT] && (world || axis !== 1 || entity[E.KIND] === 19)) {
